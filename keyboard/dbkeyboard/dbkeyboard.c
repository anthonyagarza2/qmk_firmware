...
/* This is similar to your layout but it assigns which number LED belongs to which key.
Starting with 1 due to the array being 0 filled. I would like to move this into the .h file as with the keymaps  */
